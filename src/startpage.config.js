let config = {
  terminal: {
    title: `Terminal at i@ouaone.top`,
    prefix: `<d color="#00f501">i@ouaone.top</d><d color="white">:</d><d color="blue">~</d><d color="white">$</d> `,
    welcome: 'Welcome to <d color="#00f501">i@ouaone.top</d> terminal',
    actions: [],
  },
   friends: [
    {
